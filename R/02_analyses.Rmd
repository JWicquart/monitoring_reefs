...
legend_cluster <- c("1" = glue("<b>1.</b> Very hight spatio-temporal coverage"),
                    "2" = glue("<b>2.</b> High spatio-temporal coverage"),
                    "3" = glue("<b>3.</b> Medium spatial, medium temporal coverage"),
                    "4" = glue("<b>4.</b> Medium spatial, low temporal coverage"),
                    "5" = glue("<b>5.</b> Low spatial, low temporal coverage"),
                    "6" = glue("<b>6.</b> No data"))
...
ggsave(filename = "./../figs/10_multivariate-approach-map.png", height = 5, width = 12)
...
for(i in 1:6){
  ...
  ggsave(filename = paste0("./../figs/10_multivariate-approach-map_cluster-", i,".png"), height = 5, width = 12)

}

# 5. Remove useless objects ----

rm(data_var, data_ind, data_hcpc_descriptors, data_hcpc_cluster, i)
