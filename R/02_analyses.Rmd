...
map_pixel <- ggplot() +
  ...
  geom_sf(data = data_countries_160, size = 0.2) +
  coord_sf(ylim = c(-5000000, 5000000), expand = FALSE) +
  scale_fill_manual(values = c("#fc8d59", "#f7ca18", "#91bfdb", "#2c7bb6", "white")) +
...
map_years <- ggplot() +
  ...
  geom_sf(data = data_countries_160, size = 0.2) +
  coord_sf(ylim = c(-5000000, 5000000), expand = FALSE) +
  scale_fill_manual(values = c("#fc8d59", "#f7ca18", "#2c7bb6", "white")) +
...
map_methods <- ggplot() +
  ...
  geom_sf(data = data_countries_160, size = 0.2) +
  coord_sf(ylim = c(-5000000, 5000000), expand = FALSE) +
  scale_fill_manual(values = c("#fc8d59", "#f7ca18", "#91bfdb", "#2c7bb6", "#ffec8b", "white")) +
