...
legend_regional_maps <- get_legend(legend_regional_maps)
...
plot_grid(map_methods, map_source, map_pixel, map_surveys, map_first, map_years, map_methods, 
          nrow = 6, ncol = 1, labels = c("A", "B", "C", "D", "E", "F"), align = "hv")

# 2. Save the map ----

ggsave(file = "../figs/02_supplementary-3.png", height = 12, width = 10.5)
...
plot_grid(common_legend, 
          ...
          plot_list[["n_percent"]] + theme(legend.position = "none",
                                           plot.margin = unit(c(1,3,1,3), "lines")), 
          ncol = 1, rel_heights = c(0.5, rep(1,6)))
