...
write.csv2(res_hcpc$desc.var$quanti$`4`, "./../figs/02_table-results-hcpc_clust3.csv")
...
legend_cluster <- c("1" = glue("<b>1.</b> Very high spatio-temporal coverage (<i>n</i> = 2)"),
                    ...
                    "3" = glue("<b>3.</b> Medium spatio-temporal coverage (<i>n</i> = 42)"),
...
ggsave(filename = "./../figs/03_pca-graph-ind-without-col.png", height = 6, width = 6, dpi = 600)
...
ggsave(plot_ind, filename = "./../figs/03_pca-graph-ind-with-col.png", height = 6, width = 6, dpi = 600)

# 2.4 Assembled and save the plots --

plot_grid(plot_var, plot_ind, labels = c("A", "B"))

ggsave(filename = "./../figs/02_pca-graph-combined.png", height = 5, width = 10, dpi = 600)
...
ggsave(filename = "./../figs/01_figure-5.png", height = 7, width = 10, dpi = 600)
