...
ggsave(map_methods, file = "../figs/10_global-map_most-used-method.png", height = 6, width = 10)
...
plot_grid(map_area, NULL, map_pixel, map_surveys, map_first, map_years, map_methods, nrow = 3, ncol = 2)
