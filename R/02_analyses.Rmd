...
legend_cluster <- c("1" = glue("<b>1.</b> Very high spatio-temporal coverage (<i>n</i> = ", as.character(legend_cluster[1,"n"]),")"),
                    ...
                    "3" = glue("<b>3.</b> High spatial, medium temporal coverage (<i>n</i> = ", as.character(legend_cluster[3,"n"]),")"),
...
rm(data_var, data_hcpc_descriptors, data_hcpc_cluster, i, legend_cluster, plot_var, plot_ind, plot_ind_col)
