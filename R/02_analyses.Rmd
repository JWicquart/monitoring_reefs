...
data_gcrmn <- read.csv2(file = "../data/03-merge_all_all_all_benthos_NA.csv") %>% 
  ...
  filter(Year > 1980 & Year <= 2018) %>% # Data before 1980 and after 2018   
...
ggsave(filename = "../figs/01_figure-2.png", height = 3.5, width = 12)
...
ggsave(filename = "../figs/01_figure-3.png", height = 4, width = 8)
...
ggsave(filename = "../figs/01_figure-4.png", height = 4, width = 8)
...
ggsave(filename = "../figs/03_map-size-pixel.png", height = 6, width = 8)
...
res_hcpc <- HCPC(res_pca, nb.clust = 3)
...
write.csv2(res_hcpc$desc.var$quanti$`1`, "./../figs/02_table-results-hcpc_clust1.csv")
write.csv2(res_hcpc$desc.var$quanti$`2`, "./../figs/02_table-results-hcpc_clust2.csv")
write.csv2(res_hcpc$desc.var$quanti$`3`, "./../figs/02_table-results-hcpc_clust3.csv")
...
ggsave(plot_var, filename = "./../figs/03_pca-graph-var.png", height = 6, width = 6)
...
legend_cluster <- c("1" = glue("<b>1.</b> High spatio-temporal coverage (<i>n</i> = 4)"),
                    "2" = glue("<b>2.</b> Medium spatio-temporal coverage (<i>n</i> = 42)"),
                    "3" = glue("<b>3.</b> Low spatio-temporal coverage (<i>n</i> = 48)"),
                    "4" = glue("<b>4.</b> No data (<i>n</i> = 13)"))
...
ggsave(filename = "./../figs/03_pca-graph-ind-without-col.png", height = 6, width = 6)

# 2.3 With clusters colors --

plot_ind <- ggplot(data = data_ind, aes(x = Dim.1, y = Dim.2, label = ECO_CODE_X, fill = clust)) +
...
ggsave(plot_ind, filename = "./../figs/03_pca-graph-ind-with-col.png", height = 6, width = 6)

# 2.4 Assembled and save the plots --

plot_grid(plot_var, plot_ind, labels = c("A", "B"))

ggsave(filename = "./../figs/02_pca-graph-combined.png", height = 5, width = 10)
...
ggsave(filename = "./../figs/01_figure-5.png", height = 5, width = 12)
...
for(i in 1:4){
  ...
  ggsave(filename = paste0("./../figs/03_map-cluster-", i,".png"), height = 5, width = 12)

}

# 5. Remove useless objects ----

rm(data_var, data_ind, data_hcpc_descriptors, data_hcpc_cluster, i, legend_cluster, plot_var, plot_ind)
...
ggsave(map_area, file = "../figs/03_map-descriptor-reef-area.png", height = 6, width = 10)
...
ggsave(map_pixel, file = "../figs/03_map-descriptor-pixel.png", height = 6, width = 10)
...
ggsave(map_first, file = "../figs/03_map-descriptor-first-year.png", height = 6, width = 10)
...
ggsave(map_years, file = "../figs/03_map-descriptor-years.png", height = 6, width = 10)
...
ggsave(map_surveys, file = "../figs/03_map-descriptor-surveys.png", height = 6, width = 10)
...
ggsave(map_methods, file = "../figs/03_map-descriptor-methods.png", height = 6, width = 10)
...
ggsave(filename = "../figs/03_lollipop-ecoregions-data-descriptors.png", height = 15, width = 14)
