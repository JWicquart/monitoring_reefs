...
annotation_label <- tibble(descriptor = data_var$var,
                           ...
                           y = c(0.08, 0.335, 0.35, 0.6, -0.35, -0.65))

# 1.2 Make the graph --

plot_var <- ggplot(data = data_var) +
  #geom_text_repel(aes(x = Dim.1, y = Dim.2, label = var), family = font_choose_graph) +
  geom_text(data = annotation_label, aes(x = x, y = y, label = descriptor), family = font_choose_graph) +
...
legend_cluster <- c("1" = glue("<b>1.</b> A (<i>n</i> = ", as.character(legend_cluster[1,"n"]),")"),
                    "2" = glue("<b>2.</b> B (<i>n</i> = ", as.character(legend_cluster[2,"n"]),")"),
                    "3" = glue("<b>3.</b> C (<i>n</i> = ", as.character(legend_cluster[3,"n"]),")"),
                    "4" = glue("<b>4.</b> Unknown, no data (<i>n</i> = ", as.character(legend_cluster[4,"n"]),")"))
...
ggsave(filename = "./../figs/01_figure-4.png", height = 7, width = 10, dpi = 600)
