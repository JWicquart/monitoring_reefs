...
ggsave("../figs/01_figure-1.png", height = 6, width = 10)
...
ggsave(filename = "../figs/01_figure-2.png", height = 3, width = 10)
...
ggplot(data = data_ind, aes(x = Dim.1, y = Dim.2, label = ECO_CODE_X, fill = clust)) +
...
ggsave(filename = "./../figs/03_pca-graph-ind-with-col.png", height = 6, width = 6)
...
data_descriptors_maps <- data_gcrmn_meow %>% 
  ...
  mutate(Method = as.factor(Method),
         Method = fct_relevel(Method, c("Unknown", "Photo-quadrat", "PIT", "LIT", "Video transect", "Visual census"))) %>% 
...
plot_grid(map_area, map_methods, map_pixel, map_surveys, map_first, map_years, map_methods, nrow = 3, ncol = 2)
