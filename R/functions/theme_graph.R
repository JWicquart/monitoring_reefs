theme_graph <- function(base_size = 12, base_family = font_choose_graph, base_line_size = base_size/22, base_rect_size = base_size/22){
  ...
  theme(line = element_line(colour = "black", 
        ...
        axis.title.x = element_text(size = base_size + 4, margin = margin(t = half_line/2), vjust = 1), 
        axis.title.x.top = element_text(margin = margin(b = half_line/2), vjust = 0), 
        axis.title.y = element_text(size = base_size + 4, angle = 90, margin = margin(r = half_line/2), vjust = 1), 
