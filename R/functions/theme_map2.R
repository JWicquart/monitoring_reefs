theme_map2 <- function(base_size = 12, base_family = font_choose_map, base_line_size = base_size/22, base_rect_size = base_size/22){
  ...
  theme(line = element_line(colour = "black", 
        ...
        plot.title = element_text(size = rel(1.2), hjust = 0.5, vjust = 1, margin = margin(b = half_line), face = "bold"), 
